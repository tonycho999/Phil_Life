      ...
      <div className="max-w-7xl mx-auto px-4 flex flex-col items-center">
        ...
        <div className="text-xs space-y-2 text-center text-gray-400">
          <p className="flex flex-col md:flex-row items-center justify-center gap-1 md:gap-2">
            ...
            {/* ★ 방금 만든 공식 지원 이메일 추가 완료! (클릭 시 자동 메일 작성) */}
            <span>이메일 문의: <a href="mailto:support@phcafe24.com" className="hover:text-blue-600 hover:underline transition">support@phcafe24.com</a></span>
          </p>
          <p>
