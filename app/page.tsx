  ...
  return (
    <div className="w-full min-w-0 space-y-6">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 gap-5">
         <HomeBoardWidget title="뉴스/이슈" subtitle="필리핀 주요 소식" posts={news.data} link="/news" color="red" icon={Zap} />
         <HomeBoardWidget title="커뮤니티" subtitle="자유로운 소통 공간" posts={community.data} link="/community" color="blue" icon={MessageCircle} />
         <HomeBoardWidget title="정보/팁" subtitle="생활에 도움이 되는 정보" posts={info.data} link="/info" color="green" icon={Info} />
         <HomeBoardWidget title="질문과답변" subtitle="궁금한 점 물어보세요" posts={qna.data} link="/community/qna" color="orange" icon={HelpCircle} />
      </div>
    </div>
  );
}
